...
import { getUserSessions, createSession, getEffortStats, getAmnesiaStats } from '../services/firebase/firestore'; // 🆕 Added getAmnesiaStats
    ...
    <div className="space-y-10">
      ...
      <section className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl shadow-sm border-2 border-pink-200 p-6 md:p-8">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-purple-900 flex items-center gap-2">
            🧠 Answer Amnesia Mode
            <span className="text-xs bg-pink-200 text-pink-800 px-2 py-1 rounded-full font-medium">BETA</span>
          </h3>
        </div>
        ...
        <div className="mt-6 p-4 bg-white rounded-xl border border-pink-100">
          <p className="text-sm text-gray-700 flex items-start gap-2">
            <span className="text-lg">💡</span>
            <span>
              <strong className="text-purple-900">How it works:</strong> After seeing a solution, reconstruct it from memory! AI checks your <strong>logic</strong> (not syntax). Toggle it ON in Learning Mode to test your recall!
            </span>
          </p>
        </div>
      </section>
